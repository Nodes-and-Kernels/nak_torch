...
# Same spirit as your older Joker script: initialize from N(0, I).
...
try:
    ...
    fig.suptitle(f"Final particles — Joker (M={M}, T={T}, run {R}/{R})", fontsize=13, y=1.02)
    plt.tight_layout()
